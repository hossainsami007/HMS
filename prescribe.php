...
if(isset($_POST['prescribe']) && isset($_POST['pid']) && isset($_POST['ID']) && isset($_POST['appdate']) && isset($_POST['apptime']) && isset($_POST['fname']) && isset($_POST['lname']))
    {   
        $pid=$_POST['pid'];
        $ID=$_POST['ID'];
        $fname=$_POST['fname'];
        ...
        $query=mysqli_query($con,"insert into prestb(doctor,pid,ID,fname,lname,appdate,apptime,disease,allergy,prescription)
